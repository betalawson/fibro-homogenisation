function [I_ion, S, Sinf, invtau, b, I_Na, I_CaL, I_Kr, I_Ks, I_to, I_K1, I_NaK, I_NaCa] = SecondOrderUpdateTT3breakup(V, S, Sinf_old, invtau_old, b_old, dt, I_stim, I_stim_old, params)
...
g_Kr = 0.126;         % Maximum conductance of I_Kr (nS/pF)
g_Ks = 0.321;         % Maximum conductance of I_Ks (nS/pF)
...
g_pK = 0.00219;       % Maximum conductance of I_pK (nS/pF)
g_pCa = 1.238;       % Maximum conductance of I_pCa (nS/pF)
